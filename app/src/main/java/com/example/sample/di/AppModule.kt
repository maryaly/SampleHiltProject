...
import com.example.sample.data.local.CharacterDao
import com.example.sample.data.remote.CharacterRemoteDataSource
import com.example.sample.data.remote.CharacterService
...
object AppModule {
    ...
    fun provideRetrofit(gson: Gson) : Retrofit = Retrofit.Builder()
        .baseUrl("https://sampleApi.com/api/")
